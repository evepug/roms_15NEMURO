...
/*
 *  * ** cae: If biology is run offline, then don't add tides. 
 *   * */
...
/*
 * ** Activate NEMURO_CARB_EXTRAOUT when CARB is active.
 * */

#if ( defined NEMURO || defined NEMURO_RESTRUCT ) && defined CARB
# define NEMURO_CARB_EXTRAOUT
#endif

/* 
 * ** Ensure that NEM_IRON_LIMIT is only turned in when valid bio models are active
 * ** and that NEM_IRON_RELAX and NEM_IRON_RSIN are only on if NEM_IRON_LIMIT is on
 * */

#if !( defined NEMURO || defined NEMURO_RESTRUCT ) && defined NEM_IRON_LIMIT
# undef NEM_IRON_LIMIT
#endif
#if !defined NEM_IRON_LIMIT && defined NEM_IRON_RELAX
# undef NEM_IRON_RELAX
#endif
#if !defined NEM_IRON_LIMIT && defined NEM_IRON_RSIN
# undef NEM_IRON_RSIN
#endif
/*
 * ** Activate NEMURO_ADJ_FRIENDLY for NEMURO DA.
 * ** Turn on approriate modification for NEMURO_ADJ_FRIENDLY.  
 * */

#if defined NEMURO || defined NEMURO_RESTRUCT
# if defined ADJOINT && ! defined NO_NEMURO_ADJ_FRIENDLY 
#  define NEMURO_ADJ_FRIENDLY
# endif
#endif
#if defined NEMURO_ADJ_FRIENDLY
# define NEMURO_CODE_MOD5
#endif

/*
 *  * ** Turn off NEMURO_CHL2SLPHY when NEMURO_CHL is active.
 *   * ** Activate NEMURO_CHL_NUDGECHL2N for NEMURO_CHL_NUDGECHL2N_GEIDER.
 *    * ** Activate NEMURO_CHL_CHL2NMIN if Chl2NS_min is required.
 *     * ** Activate NEMURO_CHL_STATICRATIO unless NEMURO_CHL_GEIDER 
 *      * ** or NEMURO_CHL_NUDGECHL2N is active.
 *       * */

#if defined NEMURO_CHL
# undef NEMURO_CHL2SLPHY
# if defined NEMURO_CHL_NUDGECHL2N_GEIDER
#  define NEMURO_CHL_NUDGECHL2N
# endif
# if defined NEMURO_CHL_NUDGECHL2N
#  define NEMURO_CHL_CHL2NMIN
# endif
# if defined NEMURO_CHL_NUDGECHL2N && defined NEMURO_CHL_GEIDER
#  error "NEMURO_CHL_GEIDER and NEMURO_CHL_NUDGECHL2N cannot be combined."
# endif
# if ! defined NEMURO_CHL_GEIDER && ! defined NEMURO_CHL_NUDGECHL2N
#  define NEMURO_CHL_STATICRATIO
# endif
# if defined LOGDIAGNOSTICS_NEM_CHL
#  if ! defined LOGDIAGNOSTICS_NEM_CHL_I
#   define LOGDIAGNOSTICS_NEM_CHL_I 30
#  endif
#  if ! defined LOGDIAGNOSTICS_NEM_CHL_J
#   define LOGDIAGNOSTICS_NEM_CHL_J 30
#  endif
#  if ! defined LOGDIAGNOSTICS_NEM_CHL_K
#   define LOGDIAGNOSTICS_NEM_CHL_K 42
#  endif
# endif
#endif

/*
 * ** Temporary warnings/errors.
 * */

#if defined NEMURO_CHL_GEIDER
# if defined IVLEV_EXPLICIT 
#  error "NEMURO_CHL_GEIDER and IVLEV_EXPLICIT cannot yet be combined"
# endif
# if defined NEMURO 
#  error "NEMURO_CHL_GEIDER and NEMURO cannot be combined (use NEMURO_RESTRUCT) instead"
# endif
# if defined ADJOINT || defined TANGENT
#  error "NEMURO_CHL_GEIDER does not have working tangent-linear or adjoint code at the moment."
# endif
#endif

#if defined NEMURO_CHL_NUDGECHL2N
# if defined IVLEV_EXPLICIT 
#  error "NEMURO_CHL_NUDGECHL2N and IVLEV_EXPLICIT cannot yet be combined"
# endif
# if defined NEMURO 
#  error "NEMURO_CHL_NUDGECHL2N and NEMURO cannot be combined (use NEMURO_RESTRUCT) instead"
# endif
#endif
